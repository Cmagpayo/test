 ...
 * @package    HiDef_Magic
 * @subpackage Wand
 * @copyright  Copyright (c) 2011-2013 HiDef Web Inc. (http://www.hidef.co)
 * @version    $Id:$
 * @link       none
 * @since      File available since Release 
 * 
 * Documentation for DBT API calls is located within your developer account pages
 * 
 */
...
class Dbt
{
     ...
     */
	public function getLibraryLanguage( $code = null, 
                                        $name = null, 
                                        $sortBy = null, 
                                        $fullWord = null, 
                                        $familyOnly = null )
     ...
     */
	public function getLibraryVolume( $damId = null, 
	                                  $fcbhId = null, 
	                                  $media = null, 
	                                  $delivery = null, 
									  $language = null, 
     ...
     * @param string $fullWord [true|false] interpret $name as full words only
     */
	public function getLibraryVolumeLanguage( $root = null, 
                                                $languageCode = null, 
                                                $media = null, 
												$delivery = null, 
                                                $status = null, 
     ...
     * @param string $fullWord [true|false] interpret $name as full words only
     */
	public function getLibraryVolumeLanguageFamily( $root = null, 
                                                    $languageCode = null, 
                                                    $media = null, 
													$delivery = null, 
                                                    $status = null, 
  ...
  /**
     ...
     */
	public function getLibraryVerseinfo( $damId, 
                                        $bookId = null, 
                                        $chapterId = null, 
                                        $verseStart = null, 
                                        $verseEnd = null )
   ...
   */
     ...
     */
	public function getTextVerse( $damId, 
                                    $bookId = null, 
                                    $chapterId = null, 
                                    $verseStart = null, 
                                    $verseEnd = null, 
     ...
     */
	public function getTextSearch( $damId, 
                                    $query, 
                                    $bookId = null, 
                                    $offset = null, 
                                    $limit = null )
    ...
    /**
     * Wrapper method for /video/location call
     * 
     * @param string $protocol Allows the caller to restrict potential servers 
     *      from being returned that don't support a specified protocol. 
     *      Examples: http, https, rtmp, rtmp-amazon
     */    
    public function getVideoLocation( $protocol = null )
    {
        $params = array('protocol' => $protocol);
        
        return $this->{$this->_response}('video', 'videolocation', $params);
    }
    
    /**
     * Wrapper method for /video/path call
     * 
     * @param string $damId DAM ID of volume
     * @param string $resolution The resolution of the video requested. Options are "lo", "med", "hi".
     * @param string $segmentOrder The segment number to retrieve.
     * @param string $bookId Book id of the book to get videos for (ex: Gen)
     * @param int $chapterId Chapter id of the chapter to get video for 
     * @param int $verseId Verse id of the chapter to get video for 
     */
    public function getVideoPath( $damId, $encoding = 'mp4', $resolution = null, $segmentOrder = null,
